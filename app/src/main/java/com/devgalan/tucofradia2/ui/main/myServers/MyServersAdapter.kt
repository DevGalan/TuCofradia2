...
class MyServersAdapter(
    private var myServersList: List<Server>,
    private val userId: Long,
    private val onLeaveButtonPressed: (Server) -> Unit,
    private val onEditButtonPressed: (Server) -> Unit,
    private val onJoinButtonPressed: (Server) -> Unit
) : RecyclerView.Adapter<MyServersViewHolder>() {
